    ...
    with sync_playwright() as p:
        ...
        try:
            for category in main_categories:
                ...
                if category.text_content()=='Magic Cards':
                    try:
                        # Click the category to open dropdown
                        
                        magic_cards_list = page.locator('#trading-cards > ul.menu-dropdown > li > a:has-text("Magic Cards")')
                        ...
                        for set in set_list:
                            ...
                            if cards_data:
                                write_data_to_file(cards_data, f'Magic-Cards-{set_name}', "Magic Cards")
